...
def lstm_model(embedding_weights, cv_dat, max_len, model_w, lda, dictionary, idx2word, alpha, gru_time_steps):
    """
...
def run_model():
	...
	for r in rev1k:
        ...
        model =  lstm_model(embedding_weights, cv_dat, max_sent_len, model_weights_d, lda, dictionri, idx2word, 0.15, 256)
		...
		test_lda1k = get_alpha(x_te1k, lda, dictionary, idx2word, max_len)
